 ...
 * }</pre>
 *
 * <p>Usage notes: this type is intended for local synchronous code. Do not leak this type onto
 * another thread as it is not thread-safe. For more advanced features, use {@link Span}.
 */
