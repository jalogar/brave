...
public class CurrentTraceContextAssemblyTrackingTest {
  ...
  Predicate<Integer> lessThanThreeInContext1 = i -> {
    assertContext1();
    return i < 3;
  };
  Predicate<Integer> lessThanThreeInContext2 = i -> {
    assertContext2();
    return i < 3;
  };
  ...
  @Test public void completable_subscribesUnderScope() {
    Completable source = Completable.complete()
        .doOnComplete(() -> assertContext2());
    Completable errorSource = Completable.<Integer>error(new IllegalStateException())
  ...
  @Test public void completable_unwrappedWhenNotInScope() {
    assertThat(Completable.complete())
        .isEqualTo(CompletableEmpty.INSTANCE);
  }
  ...
  @Test public void flowable_subscribesUnderScope() {
  ...
  @Test public void flowable_conditional_subscribesUnderScope() {
    Flowable<Integer> source = Flowable.range(1, 3)
  ...
  @Test public void observable() {
    ...
    subscribesInScope1RunsInScope2(source, errorSource)
        .assertResult(1, 2, 3);
  }

  @Test public void observable_subscribesUnderScope() {
    ...
    subscribesAndRunsInScope2(source, errorSource)
        .assertResult(1, 2, 3);
  }
  ...
  @Test public void single_subscribesUnderScope() {
    Single<Integer> source = Single.just(1)
        .doOnSuccess(i -> assertContext2());
  ...
  @Test public void maybe_subscribesUnderScope() {
  ...
  @Test public void parallelFlowable_subscribesUnderScope() {
    ParallelFlowable<Integer> source = Flowable.range(1, 3).parallel()
        .doOnNext(i -> assertContext2())
        .doOnComplete(() -> assertContext2());
    ParallelFlowable<Integer> errorSource = Flowable.concat(
        Flowable.<Integer>error(new IllegalStateException()),
        Flowable.<Integer>error(new IllegalStateException())
    ).parallel()
        .doOnError(t -> assertContext2());
  ...
  @Test public void parallelFlowable_conditional_subscribesUnderScope() {
    ParallelFlowable<Integer> source = Flowable.range(1, 3).parallel()
        .filter(lessThanThreeInContext2)
        .doOnNext(i -> assertContext2())
        .doOnComplete(() -> assertContext2());
  ...
  @Test public void connectableFlowable() {
  ...
  @Test public void connectableFlowable_conditional() {
    ConnectableFlowable<Integer> source, errorSource;
    try (Scope scope = currentTraceContext.newScope(context1)) {
      source = Flowable.range(1, 3)
          .filter(lessThanThreeInContext1)
  ...
  @Test public void connectableFlowable_conditional_subscribesUnderScope() {
    ConnectableFlowable<Integer> source = Flowable.range(1, 3)
        .filter(lessThanThreeInContext2)
        .doOnNext(i -> assertContext2())
        .doOnComplete(() -> assertContext2()).publish();
  ...
  @Test public void connectableObservable() {
  ...
  @Test public void connectableObservable_subscribesUnderScope() {
  ...
  @Test public void callable_completable_subscribesUnderScope() throws Exception {
    Completable source = RxJavaPlugins.onAssembly(new CallableCompletable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Completable errorSource = RxJavaPlugins.onAssembly(new CallableCompletable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new CallableCompletable<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void callable_flowable_subscribesUnderScope() throws Exception {
    Flowable<Integer> source = RxJavaPlugins.onAssembly(new CallableFlowable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Flowable<Integer> errorSource = RxJavaPlugins.onAssembly(new CallableFlowable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new CallableFlowable<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void callable_flowable_conditional_subscribesUnderScope() throws Exception {
    Flowable<Integer> source = RxJavaPlugins.onAssembly(new CallableFlowable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
  ...
  @Test public void callable_maybe_subscribesUnderScope() throws Exception {
    Maybe<Integer> source = RxJavaPlugins.onAssembly(new CallableMaybe<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Maybe<Integer> errorSource = RxJavaPlugins.onAssembly(new CallableMaybe<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new CallableMaybe<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void callable_observable_subscribesUnderScope() throws Exception {
    Observable<Integer> source = RxJavaPlugins.onAssembly(new CallableObservable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Observable<Integer> errorSource = RxJavaPlugins.onAssembly(new CallableObservable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new CallableObservable<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void callable_single_subscribesUnderScope() throws Exception {
    Single<Integer> source = RxJavaPlugins.onAssembly(new CallableSingle<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Single<Integer> errorSource = RxJavaPlugins.onAssembly(new CallableSingle<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new CallableSingle<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void scalarcallable_completable_subscribesUnderScope() throws Exception {
    Completable source = RxJavaPlugins.onAssembly(new ScalarCallableCompletable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Completable errorSource = RxJavaPlugins.onAssembly(new ScalarCallableCompletable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new ScalarCallableCompletable<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void scalarcallable_flowable_subscribesUnderScope() throws Exception {
    Flowable<Integer> source = RxJavaPlugins.onAssembly(new ScalarCallableFlowable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Flowable<Integer> errorSource = RxJavaPlugins.onAssembly(new ScalarCallableFlowable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new ScalarCallableFlowable<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void scalarcallable_flowable_conditional_subscribesUnderScope() throws Exception {
    Flowable<Integer> source = RxJavaPlugins.onAssembly(new ScalarCallableFlowable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
  ...
  @Test public void scalarcallable_maybe_subscribesUnderScope() throws Exception {
    Maybe<Integer> source = RxJavaPlugins.onAssembly(new ScalarCallableMaybe<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Maybe<Integer> errorSource = RxJavaPlugins.onAssembly(new ScalarCallableMaybe<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new ScalarCallableMaybe<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void scalarcallable_observable_subscribesUnderScope() throws Exception {
    Observable<Integer> source = RxJavaPlugins.onAssembly(new ScalarCallableObservable<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new ScalarCallableObservable<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
  ...
  @Test public void scalarcallable_single_subscribesUnderScope() throws Exception {
    Single<Integer> source = RxJavaPlugins.onAssembly(new ScalarCallableSingle<Integer>() {
      @Override public Integer call() {
        assertContext2();
        return 1;
      }
    });
    Single<Integer> errorSource = RxJavaPlugins.onAssembly(new ScalarCallableSingle<Integer>() {
      @Override public Integer call() {
        assertContext2();
        throw new IllegalStateException();
      }
    ...
    ((Callable) RxJavaPlugins.onAssembly(new ScalarCallableSingle<Integer>() {
      @Override public Integer call() {
        assertNoContext();
        return 1;
      }
